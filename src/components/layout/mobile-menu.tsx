                ...
                >
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      animate={{ 
                        opacity: hoveredItem === item.name || isActive(item.href) ? 1 : 0,
                        x: hoveredItem === item.name || isActive(item.href) ? 0 : -5
                      }}
                      transition={{ duration: 0.2 }}
                      className="ml-2"
                    >
                  ...
                  <motion.div 
                    ...
                    animate={{ 
                      scaleX: isActive(item.href) || hoveredItem === item.name ? 1 : 0,
                      opacity: isActive(item.href) || hoveredItem === item.name ? 1 : 0
                    }}
