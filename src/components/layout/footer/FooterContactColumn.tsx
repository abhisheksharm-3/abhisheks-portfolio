...
export const FooterContactColumn = () => (
  <motion.div variants={footerItemVariants} className="md:text-right flex flex-col items-start md:items-end">
    <h3 className="text-sm font-medium text-foreground/70 mb-5">Let’s Connect</h3>
    <motion.div variants={footerContainerVariants} className="space-y-4 flex flex-col items-start md:items-end">
      <motion.a
      ...
      <motion.div variants={footerItemVariants}>
        <Button variant="outline" size="sm" className="text-xs border-primary/10 bg-primary/5 hover:bg-primary/10 group" asChild>
          <Link href="/contact">
