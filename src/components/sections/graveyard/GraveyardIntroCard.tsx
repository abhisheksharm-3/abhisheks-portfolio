        ...
        <motion.div variants={containerVariants} className="p-8 sm:p-10">
          <div className="flex flex-col sm:flex-row gap-8 sm:gap-12">
            ...
            >
              ...
              >
                Like every dev, I’ve got my fair share of projects that never
                made it out alive. Some broke under tech challenges, some lost
                relevance, and some just ran out of steam.
              </motion.p>
              <motion.p
                variants={itemVariants}
                className="text-foreground/60 text-sm sm:text-base font-light leading-relaxed"
              >
                Still, none of them were wasted. Each one left me with lessons,
                skills, or insights that shaped the projects I shipped later. So
                here’s to the ones that didn’t make it — they paved the way for
                everything that did.
              </motion.p>
            </motion.div>
          </div>
